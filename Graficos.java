...
public void dibujarGrafo(){
       ...
       int x = evt.getX();
        ...
        if(evt.isMetaDown()){            
            ...
            if(nodoInicio == null){
                ...
                nodoInicio.getCirculo().setColor(Color.green);
            }else{             
                nodoFin = grafo.buscarNodo(x, y);
                Dijkstra disjktra = new Dijkstra(grafo);
    ...
    private void crearArista(){
        int intDis = ingresarDistancia();
        Arista arista = new Arista();
        arista.setPeso(intDis);
